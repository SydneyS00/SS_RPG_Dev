...
public class Menu : MonoBehaviourPunCallbacks, ILobbyCallbacks
{
    ...
    void Start()
    {
        ...
        //enable the cursor since we hide it when the game is playing
    ...
    //changes the current visible screen
    ...
    void UpdateLobbyUI()
    {
        // enable or disable the start game button depending if host
    ...
    void UpdateLobbyBrowserUI()
    {
        ...
        for(int x = 0; x < roomList.Count; ++x)
        {
            ...
            //set the button on the click event
